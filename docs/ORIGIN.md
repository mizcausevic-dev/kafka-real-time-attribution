...
**kafka-real-time-attribution** grew out of repeated work around event-driven revenue systems, where the hardest problems were rarely about raw data collection. The real challenge was turning scattered evidence into something humans could govern quickly.
...
This repo also avoids trying to be a vague platform for everything. Its value comes from being opinionated about a real problem: Java Kafka attribution engine for real-time multi-touch channel credit, weighted conversion revenue, and replay-safe analytics reporting.
