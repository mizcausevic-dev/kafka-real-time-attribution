...
### Released
- Released **kafka-real-time-attribution** publicly as a reviewable operating system for event-driven revenue systems.
...
### Shipped
- Cut the first coherent internal version of **kafka-real-time-attribution** with stable domain objects, review surfaces, and decision outputs.
