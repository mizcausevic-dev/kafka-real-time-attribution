...
### Released
- Published **kafka-real-time-attribution** as a public, portfolio-grade event-driven revenue systems system.
...
### Shipped
- Cut the first coherent internal version of the product shape behind **kafka-real-time-attribution**.
- Standardized the core objects, decision surfaces, and operator outputs around the repo's main working problem.
- Established the first reviewable version of the architecture described as: Java Kafka attribution engine for real-time multi-touch channel credit, weighted conversion revenue, and replay-safe analytics reporting.
...
- That insight became the basis for **kafka-real-time-attribution**.
